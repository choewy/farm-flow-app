...
export function FarmUpdateModal({ isOpen, onClose, onSuccess, farmId, currentName }: FarmUpdateModalProps) {
      ...
      >
        <div className="relative p-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-slate-400 mt-2 font-medium">관리하시는 농장의 이름을 <br/>변경하실 수 있습니다.</p>
          </div>
