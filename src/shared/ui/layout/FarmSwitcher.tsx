  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <span className="text-[11px] font-black text-slate-700 uppercase tracking-wider max-w-[90px] truncate">
              ...
              return (
                ...
                >
                  <div className="flex items-center space-x-3 text-left">
                    ...
                    <div>
                      <p className={`text-sm font-bold truncate max-w-[120px] ${isActive ? 'text-primary' : 'text-slate-800'}`}>
                        {farm.name}
                      </p>
